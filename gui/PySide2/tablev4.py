# This version (4) implements a more robust interface:
#   QMainWindow for a better base
#   Labels for the edit fields
#   Clear edit fields after adding a row
#   Menu placeholders
#   Splitter for second view
