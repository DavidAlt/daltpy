# This version implements sorting, manual reordering via headers
...
class TestApp(QWidget):
    def __init__(self, data_list, header, *args):
        ...
        tmodel = MyTableModel(self, data_list, header) # actual model
        pmodel = QSortFilterProxyModel() # proxy model for sorting
        pmodel.setSourceModel(tmodel) # assign actual model to the proxy
        
        tview = QTableView()
        tview.setModel(pmodel) # assign the proxy to the view
